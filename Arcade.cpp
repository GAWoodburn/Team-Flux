...
Arcade::Arcade(int& playerMoney, bool& playerDeath) {
	...
	system("cls");
	cout << delimiter;
	cout << "As you walk around the park, you notice a mysterious tent... \n";
	...
	here:  // Jump to here if player wishes to choose another game
		...
		case 'a':
			...
			cout << "\n\nExcitement and terror take over as you realize you've transformed into Pac-Man and you must clear the level or perish!";
		...
		case 'b':
			...
			this_thread::sleep_for(chrono::seconds(4));
			cout << "\n\nScorpion: Ssssoo, you wissssh to challenge me???";
		...
		case 'd':
			...
			this_thread::sleep_for(chrono::seconds(4));
			cout << "\n\n'COMMANDER: Your mission is simple!'";
			cout << "\n\n'SURVIVE!'";
		...
		case 'e':
			...
			{
				playerMoney = playerMoney - PENALTY;  // Accumulate
				cout << "\n\nYou attempt to shoot every asteroid with rapid fire to blast them away!";
