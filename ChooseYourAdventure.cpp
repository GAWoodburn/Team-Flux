...
ChooseYourAdventure::ChooseYourAdventure(int& personalityTestInput) {
	...
	else
	{
		...
		cout << "\nThis personality test will determine which part of the theme park will be best for you." << endl;
		...
		cout << "\nYou have just found out that you have the day off from all scheduled activities. What do you do?" << endl;

		cout << "\n1. Barricade yourself indoors and watch Spongebob Squarepants all day while eating candy and ice cream." << endl; // Kiddie park

		cout << "\n2. Call up your friends and tell them you are getting the boat ready to go out to the lake all day." << endl; // Waterpark

		cout << "\n3. Whip out your computer and start gathering data for how to assemble your fantasy football team for the high-stakes league you are in." << endl; // casino

		cout << "\n4. Drive over to the local airport and take those skydiving lessons like you have always wanted to." << endl; // thrill park (roller park)

		cout << "\n5. Hop on your gaming rig and play online with your buddies, all while chugging Mountain Dew for 24 hours." << endl; // arcade

		cin >> personalityTestInput;

		if (personalityTestInput != 1 && personalityTestInput != 2 && personalityTestInput != 3 && personalityTestInput != 4 && personalityTestInput != 5 && personalityTestInput != 6)

		{

			cout << "\n\nInvalid personality test input. Please enter a number corresponding to the above numbers." << endl;
		...
		cout << "\nDetermining best part of theme park to fit your needs..." << endl; //Can maybe put fancy sleep statement here.
